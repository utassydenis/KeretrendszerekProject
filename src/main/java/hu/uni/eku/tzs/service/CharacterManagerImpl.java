...
public class CharacterManagerImpl implements CharacterManager {
    ...
    public Characters readById(int id) throws CharacterNotFoundException {
        ...
        if (entity.isEmpty()) {
            throw new CharacterNotFoundException(String.format("Cannot find character with ID %s , it doesn't exist.", id));
        }
    ...
    public Characters modify(Characters character) throws CharacterNotFoundException {
        ...
        if (characterRepository.findById(entity.getId()).isEmpty()) {
            throw new CharacterNotFoundException(String.format("Cannot modify character with ID %s , it doesn't exist.", character.getId()));
        }
    ...
    public void delete(Characters character) throws CharacterNotFoundException {
        if (characterRepository.findById(character.getId()).isEmpty()) {
            throw new CharacterNotFoundException(String.format("Cannot delete character with ID %s , it doesn't exist.", character.getId()));
        }
